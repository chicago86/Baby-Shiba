...
const faqData = [
  ...
  {
    id: 2,
    title: "How can I buy a Baby Shiba NFT",
    content:
  ...
  {
    id: 4,
    title: "How much does it cost to buy one or your Baby Shiba NFT",
    content:
      "The Price of Minting and Sale will be announced soon.",
  },
  {
    id: 5,
    title: "WHY DID YOU CHOOSE BABY SHIBA ?",
    content:
      "We are all investors and crypto enthusiasts at heart. Shibaz have been used for over decades to symbolize the aggressive financial optimism and prosperity of the markets. We can’t think of a better avatar to use going into the Metaverse. So we gave the Baby Shiba a 3.0 upgrade and made them future-proof.",
  },
];
